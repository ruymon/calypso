...
export default {
  ...
  "landing.features.title": "Abordando suas preocupações com soluções sem esforço!",
  "landing.features.subtitle": "O Skyscope é projetado para proporcionar a você a melhor experiência em simulação de voo.",
  "landing.features.feature1.title": "Dados em tempo real",
  "landing.features.feature1.subtitle": "Obtenha dados em tempo real de qualquer voo na rede.",
  "landing.features.feature2.title": "Amigável ao usuário",
  "landing.features.feature2.subtitle": "O Skyscope é projetado para ser intuitivo e fácil de usar.",
  "landing.features.feature3.title": "Personalizável",
  "landing.features.feature3.subtitle": "Personalize sua experiência de acordo com suas necessidades.",

  "landing.footer.builtBy": "Construído por \"simuleiros\" para a comunidade.",
  ...
  "legal.terms.topic2.list2": "usar os materiais para qualquer finalidade comercial ou para exibição pública;",
  "legal.terms.topic2.list3": `tentar engenharia reversa de qualquer software contido no site ${siteConfig.name};`,
  "legal.terms.topic2.list4": "remover quaisquer notações de direitos autorais ou outras notações proprietárias dos materiais; ou",
  "legal.terms.topic2.list5": 'transferir os materiais para outra pessoa ou "espelhar" os materiais em qualquer outro servidor.',
  ...
  "legal.terms.topic8.content": "Por favor, leia nossa Política de Privacidade.",
  ...
  "legal.privacy.topic2.content": 'No curso do uso dos Serviços, coletamos informações pessoalmente identificáveis, na forma de Identificadores Persistentes, incluindo Endereço IP. Coletamos e armazenamos essas informações pessoais exclusivamente com o objetivo de fornecer suporte para as operações internas de nossos Serviços e de nosso Site.',
  "legal.privacy.topic3.title": "Como usamos suas informações",
  "legal.privacy.topic3.list1": "Fornecer, operar e manter nosso site",
  "legal.privacy.topic3.list2": "Comunicar-se com você, diretamente ou por meio de um de nossos parceiros, incluindo atendimento ao cliente, fornecer atualizações e outras informações relacionadas ao site e para fins de marketing e promoção (opt in).",
  ...
  "legal.privacy.topic6.title": "Políticas de Privacidade de Parceiros de Publicidade",
  ...
  "legal.privacy.topic7.content2": 'Você pode optar por desativar os cookies por meio das opções individuais do seu navegador. Para obter informações mais detalhadas sobre o gerenciamento de cookies com navegadores da web específicos, consulte os sites respectivos dos navegadores.',
  "legal.privacy.topic8.title": "Links para Outros Sites",
  "legal.privacy.topic8.content": 'Nossos serviços podem conter links para outros sites, aplicativos e serviços online. Se você optar por visitar um serviço de terceiros ou clicar em outro link de terceiros, será direcionado para o site, aplicativo ou serviço de terceiros. O fato de vincular a um site, conteúdo não é um endosso, autorização ou representação de nossa afiliação com esse terceiro, nem é um endosso de suas políticas ou práticas de privacidade ou segurança da informação. Não exercemos controle sobre sites ou serviços de terceiros.',
  "legal.privacy.topic9.title": "Direitos de Privacidade do CCPA (Não Venda Minhas Informações Pessoais)",
  "legal.privacy.topic9.content": 'De acordo com o CCPA, entre outros direitos, os consumidores da Califórnia têm o direito de:',
  "legal.privacy.topic9.list1": 'Solicitar que um negócio que coleta dados pessoais de um consumidor divulgue as categorias e peças específicas de dados pessoais que o negócio coletou sobre os consumidores.',
  "legal.privacy.topic9.list2": 'Solicitar que um negócio exclua qualquer dado pessoal sobre o consumidor que o negócio tenha coletado.',
  "legal.privacy.topic9.list3": 'Solicitar que um negócio que vende dados pessoais de um consumidor não venda os dados pessoais do consumidor.',
  "legal.privacy.topic9.content2": 'Se você fizer uma solicitação, temos um mês para responder. Se você deseja exercer qualquer um desses direitos, entre em contato conosco em',
  "legal.privacy.topic10.title": "Compartilhamento de Informações",
  "legal.privacy.topic10.content": "NÃO COMPARTILHAREMOS, VENDEREMOS, ALUGAREMOS OU NEGOCIAREMOS SUAS INFORMAÇÕES PESSOAIS COM OUTRAS PARTES, EXCETO CONFORME FORNECIDO ABAIXO:",
  "legal.privacy.topic10.content2": "Informações Pessoais: Podemos compartilhar informações pessoais, incluindo o Endereço IP, com o objetivo de fornecer suporte para as operações internas de nossos serviços e de nosso site.",
  "legal.privacy.topic10.content3": "\"Suporte para as operações internas de nossos Serviços e de nosso Site\" significa atividades necessárias para manter ou analisar o funcionamento dos serviços ou do site; realizar comunicações de rede; autenticar usuários ou personalizar conteúdo; garantir conformidade legal ou regulatória; ou realizar outras análises de uso. Através de nossos serviços e site, nenhuma outra informação pessoal é coletada e os identificadores persistentes não são usados ou divulgados para contatar um indivíduo específico.",
  "legal.privacy.topic11.title": "Transferência Internacional",
  "legal.privacy.topic11.content": "Suas informações podem ser transferidas para - e mantidas em - computadores localizados fora do seu estado, província, país ou outra jurisdição governamental, onde as leis de privacidade podem não ser tão protetoras quanto aquelas em sua jurisdição. Se você estiver localizado fora dos Estados Unidos e optar por fornecer informações para nós, podemos transferir as informações pessoais para os Estados Unidos e processá-las lá. O uso de nossos serviços ou site representa seu consentimento a esta Política de Privacidade e seu acordo com essa transferência.",
  "legal.privacy.topic12.title": "Direitos de Proteção de Dados GDPR",
  "legal.privacy.topic12.content": "Gostaríamos de garantir que você esteja totalmente ciente de todos os seus direitos de proteção de dados. Todo usuário tem direito ao seguinte:",
  "legal.privacy.topic12.list1": "O direito de acessar - Você tem o direito de solicitar cópias de seus dados pessoais. Podemos cobrar uma pequena taxa por este serviço.",
  "legal.privacy.topic12.list2": "O direito de retificação - Você tem o direito de solicitar que corrijamos qualquer informação que você acredita estar imprecisa. Você também tem o direito de solicitar que completemos as informações que você acredita estar incompletas.",
  "legal.privacy.topic12.list3": "O direito ao apagamento - Você tem o direito de solicitar que apaguemos seus dados pessoais, sob certas condições.",
  "legal.privacy.topic12.list4": "O direito de restringir o processamento - Você tem o direito de solicitar que restrinjamos o processamento de seus dados pessoais, sob certas condições.",
  "legal.privacy.topic12.list5": "O direito de se opor ao processamento - Você tem o direito de se opor ao nosso processamento de seus dados pessoais, sob certas condições.",
  "legal.privacy.topic12.list6": "O direito à portabilidade de dados - Você tem o direito de solicitar que transfiramos os dados que coletamos para outra organização, ou diretamente para você, sob certas condições.",
  "legal.privacy.topic12.content2": "Se você fizer uma solicitação, temos um mês para responder. Se você deseja exercer qualquer um desses direitos, entre em contato conosco em",
  "legal.privacy.topic13.title": "Informações para Crianças",
  "legal.privacy.topic13.content": "Outra parte de nossa prioridade é adicionar proteção para crianças enquanto usam a internet. Incentivamos os pais e responsáveis a observar, participar e/ou monitorar e orientar a atividade online deles.",
