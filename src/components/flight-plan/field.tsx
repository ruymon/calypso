...
export function FlightPlanTextarea({ value, prefix }: { value: string; prefix?: string }) {
  return (
    <div className="uppercase flex flex-col min-h-[5rem] rounded-md border border-input bg-background ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 cursor-not-allowed">
      ...
      <span className="text-sm font-medium p-2 font-mono">{value}</span>
    </div>
  );
};
