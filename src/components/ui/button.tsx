  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline: "border border-input bg-transparent hover:bg-muted text-muted-foreground hover:text-accent-foreground",
        'glass-outline': "border border-input bg-transparent backdrop-blur-md hover:bg-foreground text-muted-foreground hover:text-secondary",
